...
static const char * const sel_pll5_4[] = { ".pll5", ".pll5_fout1ph0" };
...
static const struct {
	...
	.common = {
		...
		DEF_FIXED(".pll2_fout3", CLK_PLL2_FOUT3, CLK_PLL2, 2, 6),
		DEF_FIXED(".pll2_fout3_div2", CLK_PLL2_FOUT3_DIV2, CLK_PLL2_FOUT3, 1, 2),
		DEF_FIXED(".pll3", CLK_PLL3, CLK_EXTAL, 200, 3),
		DEF_FIXED(".pll3_400", CLK_PLL3_400, CLK_PLL3, 1, 4),
		DEF_FIXED(".pll3_533", CLK_PLL3_533, CLK_PLL3, 1, 3),

		DEF_FIXED(".pll5", CLK_PLL5, CLK_EXTAL, 125, 1),
		DEF_FIXED(".pll5_fout1ph0", CLK_PLL5_FOUT1PH0, CLK_PLL5, 1, 2),
		DEF_FIXED(".pll5_fout3", CLK_PLL5_FOUT3, CLK_PLL5, 1, 6),
		DEF_MUX(".sel_pll5_4", CLK_SEL_PLL5_4, SEL_PLL5_4, sel_pll5_4),
		...
		DEF_FIXED("M1", R9A07G044_CLK_M1, CLK_PLL5, 1, 1),
		DEF_FIXED("M2", R9A07G044_CLK_M2, CLK_PLL3_533, 1, 2),
		DEF_2DIV("M3", R9A07G044_CLK_M3, CLK_SEL_PLL5_4,
			 DIVDSIA, DIVDSIB, dtable_1_8, dtable_1_16),
		DEF_DIV("M4", R9A07G044_CLK_M4, CLK_PLL2_FOUT3_DIV2,
			 DIVDSILPCLK, dtable_16_128),
		DEF_FIXED("pll3_533_div4", CLK_PLL3_533_DIV4, CLK_PLL3_533, 1, 4),
...
static const struct {
	...
	.common = {
		DEF_MOD("gic",		R9A07G044_GIC600_GICCLK, R9A07G044_CLK_P1,
					0x514, 0, MSTOP(REG1_MSTOP, BIT(7))),
		...
		DEF_MOD("gpt",		R9A07G044_GPT_PCLK, R9A07G044_CLK_P0,
					0x540, 0, MSTOP(MCPU1_MSTOP, BIT(4))),
		DEF_MOD("poeg_a",	R9A07G044_POEG_A_CLKP, R9A07G044_CLK_P0,
					0x544, 0, MSTOP(MCPU1_MSTOP, BIT(5))),
		DEF_MOD("poeg_b",	R9A07G044_POEG_B_CLKP, R9A07G044_CLK_P0,
					0x544, 1, MSTOP(MCPU1_MSTOP, BIT(6))),
		DEF_MOD("poeg_c",	R9A07G044_POEG_C_CLKP, R9A07G044_CLK_P0,
					0x544, 2, MSTOP(MCPU1_MSTOP, BIT(7))),
		DEF_MOD("poeg_d",	R9A07G044_POEG_D_CLKP, R9A07G044_CLK_P0,
					0x544, 3, MSTOP(MCPU1_MSTOP, BIT(8))),
		DEF_MOD("wdt0_pclk",	R9A07G044_WDT0_PCLK, R9A07G044_CLK_P0,
					0x548, 0, 0),
		DEF_MOD("wdt0_clk",	R9A07G044_WDT0_CLK, R9A07G044_OSCCLK,
					0x548, 1, MSTOP(REG0_MSTOP, BIT(2))),
		DEF_MOD("wdt1_pclk",	R9A07G044_WDT1_PCLK, R9A07G044_CLK_P0,
					0x548, 2, 0),
		DEF_MOD("wdt1_clk",	R9A07G044_WDT1_CLK, R9A07G044_OSCCLK,
					0x548, 3, MSTOP(REG0_MSTOP, BIT(3))),
		DEF_MOD("wdt2_pclk",	R9A07G044_WDT2_PCLK, R9A07G044_CLK_P0,
					0x548, 4, 0),
		DEF_MOD("wdt2_clk",	R9A07G044_WDT2_CLK, R9A07G044_OSCCLK,
					0x548, 5, MSTOP(REG0_MSTOP, BIT(1))),
		DEF_MOD("spi_clk2",	R9A07G044_SPI_CLK2, R9A07G044_CLK_SPI1,
					0x550, 0, 0),
		DEF_MOD("spi_clk",	R9A07G044_SPI_CLK, R9A07G044_CLK_SPI0,
					0x550, 1, MSTOP(MCPU1_MSTOP, BIT(1))),
		...
		DEF_MOD("cru_aclk",	R9A07G044_CRU_ACLK, R9A07G044_CLK_M0,
					0x564, 3, 0),
		DEF_MOD("dsi_pllclk",	R9A07G044_MIPI_DSI_PLLCLK, R9A07G044_CLK_M1,
					0x568, 0, 0),
		DEF_MOD("dsi_sysclk",	R9A07G044_MIPI_DSI_SYSCLK, CLK_PLL3_533_DIV4,
					0x568, 1, 0),
		...
		DEF_MOD("dsi_vclk",	R9A07G044_MIPI_DSI_VCLK, R9A07G044_CLK_M3,
					0x568, 4, MSTOP(PERI_VIDEO_MSTOP,
							BIT(5) | BIT(6))),
		DEF_MOD("dsi_lpclk",	R9A07G044_MIPI_DSI_LPCLK, R9A07G044_CLK_M4,
					0x568, 5, 0),
		DEF_COUPLED("lcdc_clka", R9A07G044_LCDC_CLK_A, R9A07G044_CLK_M0,
					0x56C, 0, MSTOP(PERI_VIDEO_MSTOP,
							BIT(7) | BIT(8) | BIT(9))),
		DEF_COUPLED("lcdc_clkp", R9A07G044_LCDC_CLK_P, R9A07G044_CLK_ZT,
					0x56C, 0, 0),
		...
		DEF_MOD("ssi3_sfr",	R9A07G044_SSI3_PCLK_SFR, R9A07G044_CLK_P0,
					0x570, 7, 0),
		DEF_MOD("src",		R9A07G044_SRC_CLKP, R9A07G044_CLK_P0,
		...
		DEF_MOD("adc_pclk",	R9A07G044_ADC_PCLK, R9A07G044_CLK_P0,
					0x5a8, 1, 0),
		DEF_MOD("tsu",		R9A07G044_TSU_PCLK, R9A07G044_CLK_TSU,
...
static struct rzg2l_reset r9a07g044_resets[] = {
	...
	DEF_RST(R9A07G044_SRC_RST, 0x874, 0),
